...
#!/usr/bin/env python3
"""
R36F.15.1 - CONTINUOUS FRESH MARKET REEVALUATION FOR CONTROLLED WEEX DEMO
...
PURPOSE = (
    "CONTINUOUS FRESH MARKET REEVALUATION: preserve the complete R36F.15 "
    ...
    "but rerun the complete read/evaluate/authorize pipeline every configured runtime interval so EMA, "
    "mark price, historical clusters and market eligibility are never frozen at startup. Production "
    "/capi/v3/order and every real-money mutation remain hard-disabled."
)
