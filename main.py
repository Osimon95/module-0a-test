...
PURPOSE = (
    "R36F.15.10.3 AUTO-MODE MERGER: preserve the complete frozen "
    "R36F.15.9 execution/readiness baseline while integrating the "
    "R36F.15.10.2 SCALP/STRUCTURE/BREAKOUT regime classifier into "
    "continuous fresh-market reevaluation. Production real-money "
...
# ============================================================
# R36F.15.10.3 COMPLETE REEVALUATION
# ============================================================
...
async def run_r36f12():
    ...
    log(
        f"{STAGE}: "
        "R36F.15.10.3 AUTO-MODE MERGED REEVALUATION"
    )
    ...
    if (
        ...
        try:
            ...
            log(
                "R36F.15.10.3 SHORT TP = REJECTED "
                + str(exc)
            )
    ...
    try:
        ...
        diagnostic_check(
            "R36F15103_AUTO_MODE_REEVALUATION",
            True,
            (
                "raw_mode="
                + str(
    ...
    if (
        ...
        try:
            ...
            log(
                "R36F.15.10.3 BALANCE READINESS ERROR = "
                + str(exc)
            )
    ...
    if (
        ...
        try:
            ...
            log(
                "R36F.15.10.3 PROTECTIVE STOP ERROR = "
                + str(exc)
            )
    ...
    check(
        "R36F15103_ZERO_WRITE_INVARIANT",
