...
PURPOSE = (
    "PROTECTIVE STOP LOSS-BUDGET HARDENING: preserve the complete R36F.13.1 "
    "protective-stop risk-envelope + R36F.12 EMA19/EMA50/EMA200 + Telegram + "
    "TP/readiness/writer baseline, calculate the expected loss at the mandatory "
    "protective stop for the actual canary quantity, require that loss to remain "
    "inside both the configurable account-loss budget and isolated entry-margin "
    "budget before authorization, and keep ALL exchange mutation and real execution "
    "hard-disabled in R36F.13.2"
)
